...
int main(int argc, char **argv)
{
    ...
    cout << ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::" << endl;
    cout << ":: KONAMI SNES DECOMPRESSOR by proton - edited by bankbank               ::" << endl;
    ...
    while (in_pos<comp_size-2&&out_pos<DATA_SIZE)
    {
        ...
        case (0x04):
            if(extensive_output==1)cout << " RAW (0x81 - 0x9F)";
        ...
        case (0x05):
            if(extensive_output==1)cout << " RLE_A0 (0xA0 - 0xBF)";
        ...
        case (0x06):
            if(extensive_output==1)cout << " RLE_C0 (0xC0 - 0xDF)";
            cnt = (in_buf[in_pos-1] & 0x1f) + 2;
            chr = in_buf[in_pos++];
            for (int i=0; i<cnt; i++)
            {
        ...
        case (0x07):
            if(extensive_output==1)cout << " RLE_E0 (0xE0 - 0xFF)";
            //cout << "\tt=" << (int)t;
        ...
        default:
            if(extensive_output==1)cout << " LZ (0x00 - 0x7F)";
   ...
   if(extensive_output==1)cout << hex << "Compressed data size: " << (int)comp_size << "\n";
